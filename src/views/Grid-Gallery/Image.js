...
class Image extends Component {
    ...
    render () {
        ...
        var tags = (typeof this.props.item.tags === 'undefined' || !this.props.showTags ) ? <noscript/> :
        ...
        return (
            ...
            //     width: "100%"}}
                >
                <FavoriteButton primaryKey={this.props.item.primaryKey} updoot={this.props.item.updoot}/>
                <SourceButton source={this.props.item.source}/>
                <DeleteButton primaryKey={this.props.item.primaryKey}/>
                </div>
